...
int main()
{
    ...
    //setup Poisson matrix (outside of loop since never changes)
    poisson.set_main_diag(epsilon);
    poisson.set_lower_diag(epsilon);
    poisson.set_upper_diag(epsilon);
