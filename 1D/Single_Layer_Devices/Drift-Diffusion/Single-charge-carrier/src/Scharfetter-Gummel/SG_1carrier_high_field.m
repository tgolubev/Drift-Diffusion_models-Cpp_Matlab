...
%------------------------------------------------------------------------------------------------        
    ...
    %Analytic Result Calculation: NOTE: this is from Mott Gurney equation!
    for i=2:num_cell
    ...
    str = sprintf('%.2f',Va);
    filename = [str 'V.txt'] 
    fid = fopen(fullfile('C:\Users\Tim\Documents\Duxbury_group_research\Github_codes\Drift-Diffusion_models\1D\Drift-Diffusion\Single-charge-carrier\src\Scharfetter-Gummel',filename),'w');   %w: Open or create new file for writing
