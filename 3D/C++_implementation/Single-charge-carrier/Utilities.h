...
public:
    ...
    void write_details(const Parameters &params, double Va, const Eigen::Tensor<double, 3> &V_matrix, const Eigen::Tensor<double, 3> &p, const Eigen::Tensor<double, 3> &J_total_Z, const std::vector<double>  &Up);
